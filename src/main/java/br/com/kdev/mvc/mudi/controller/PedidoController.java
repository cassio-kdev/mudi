...
import br.com.kdev.mvc.mudi.dto.RequisicaoNovoPedido;
...
import br.com.kdev.mvc.mudi.orm.UserRepository;
...
public class PedidoController {
	...
	@PostMapping("novo")
	public String novo(@Valid RequisicaoNovoPedido request, BindingResult result) {
